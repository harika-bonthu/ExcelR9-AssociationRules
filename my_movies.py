...
# create a pandas dataframe from my_movies.csv
data = pd.read_csv('my_movies.csv')
# print(data)

mydata = data.iloc[:, 5:15]
# print(mydata.columns)

# apriori algorithm
frequent_itemsets1 = apriori(mydata, min_support=0.02, use_colnames=True, max_len=5) # 2% min support
# print(frequent_itemsets1) # 52 itemsets

frequent_itemsets2 = apriori(mydata, min_support=0.05, use_colnames=True, max_len=4) # 5% min support
# print(frequent_itemsets2) # 51 itemsets
